...
> You need to stop forcing it and start connecting with the intention behind the action. Because lighting a candle
> without focus? That's just ~~magick~~ setting things on fire, babe.
...
<Video
  ...
  caption="An example of setting up a basic altar space before performing ritual work."
/>
